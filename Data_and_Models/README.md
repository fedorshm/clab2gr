...
Файл annotated_document1.pdf содержит детектированные элементы документа с учётом всех настроек актуальной модели, код использования модели для этого представлен в файле Сonfidence.ipynb
